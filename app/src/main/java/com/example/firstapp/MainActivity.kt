...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLesson28?.setOnClickListener {
            val intent = Intent(this, Lesson28::class.java)
            startActivity(intent)
        }

        btnLesson29?.setOnClickListener {
            val intent = Intent(this, Lesson29::class.java)
            startActivity(intent)
        }

        btnLesson33?.setOnClickListener {
        ...
        btnLesson40?.setOnClickListener {
            val intent = Intent(this, Lesson40::class.java)
            startActivity(intent)
        }

        btnLesson41?.setOnClickListener {
